# To check the version of python  use type (python --version) in terminal.
""""
    version is release of a software product.
    every software product will update version if they find any bugs in software
    and also for adding new features and improvement.
